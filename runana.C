...
{
TString anastring =".x /home/work/risharma/work/git/Skimmer/anaCond.C(\""+ifname+"\",\""+ofname+"\",\""+data+"\",\""+year+"\",\""+lep+"\",\""+era+"\",\""+MC+"\")";
gSystem->Load("/home/work/risharma/work/git/Skimmer/VLLAna_C.so");
